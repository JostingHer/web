    ...
    <div className='shadow-md w-full fixed top-0 left-0 z-[20]'>
      <div className='md:flex items-center justify-around bg-white py-4 md:px-10 px-5'>
           <div className="flex justify-between">
            ...
            <ol ref={menuRef} className={`flex flex-col justify-center  md:flex-row md:items-center md:pb-0 pb-10 absolute md:static bg-white md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 transition-all duration-500 ease-in ${open ? 'top-14 max-h-fit' : 'top-[-490px]'}`}>
                    <li className='link md:ml-8 text-xl md:my-0 my-4 font-semibold'>
                        <Link href={`/${locale}/#About`}>{t("aboutMe")}</Link>
                    </li>
                    <li className='link md:ml-8 text-xl md:my-0 my-4 font-semibold'>
